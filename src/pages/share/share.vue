<template>
    <div class="container">
        ...
        <div class="page02">
            <div class="top-bg">
                <img ref="step" class="top-img pc" :src="require(`@/assets/img/index2-1/index_2-1.png`)" alt="" />
                ...
                <!-- Bubble -->
                <img ref="fb" class="bubble-1" :src="require(`@/assets/img/index2-1/93.png`)" alt="" />
                ...
                <div class="chat-swiper">
                    <swiper class="swiper" :options="swiperOptionChat">
                        <swiper-slide v-for="(item, index) in chats" :key="index">
                            <div class="frame">
                                <img :src="require(`@/assets/img/index2-1/left.png`)" alt="" />
                                <div class="content">
                ...
                <div class="image-swiper">
                    <swiper class="swiper" :options="swiperOptionImage">
                        <swiper-slide v-for="index in 11" :key="index">
                            <img class="image" :src="require(`@/assets/img/index2-1/images_${index}.png`)" alt=""
                        /></swiper-slide>
                    </swiper>
                </div>
                <a href="https://mamibuy.com.tw/talk/forum/topic/438210" target="_blank">
                    <img class="share-more" :src="require(`@/assets/img/index2-1/btn-shareMore.png`)" alt="" />
                    <img
                ...
                <a href="#" target="_blank">
                    ...
                    <img
                        ...
                        :src="require(`@/assets/img/index2-1/btn-likeItTonight-hover.png`)"
                        alt="" />
                </a>
