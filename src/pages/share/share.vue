    ...
    <div class="container">
        <div class="page02">
            <div class="top-bg">
                ...
                <!-- Bubble -->
                <img class="bubble-1" :src="require(`@/assets/img/index2-1/93.png`)" alt="" />
                ...
                /></a>
                <img class="image1" :src="require(`@/assets/img/index2-1/images_1.png`)" alt="" />
                <img class="image2" :src="require(`@/assets/img/index2-1/images_2.png`)" alt="" />
                <img class="image3" :src="require(`@/assets/img/index2-1/images_3.png`)" alt="" />
                <a href=""
                        ...
                        <div class="content-box">
                            ...
                            <div class="content">
                                ...
                                <p>
                                    ...
                                    <a target="blank" href="https://www.facebook.com/lglife"
                    ...
                    <div
                        ...
                        <div class="content-box">
                            ...
                            <div class="step2" v-if="apply.step === 2">
                                ...
                                <div class="agree">
                                    <input v-model="apply.agree" id="agree" type="checkbox" />
                                    <label for="agree">已詳閱並同意抽獎活動辦法</label>
                                </div>
                                <button :class="{ disabled: !apply.agree }" @click="onStep2Click()">下一步</button>
                            </div>
                            <div class="step3" v-if="apply.step === 3">
                                ...
                                <button @click="onStep3Click()">下一步抽大獎</button>
                            </div>
